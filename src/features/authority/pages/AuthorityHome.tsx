    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card p-6">
          <h3 className="text-lg font-semibold text-text-primary mb-4">Gestión de Casos</h3>
          <p className="text-text-secondary">Aquí podrás gestionar y dar seguimiento a los casos de personas desaparecidas.</p>
        </div>
      </div>
    </div>
  )
